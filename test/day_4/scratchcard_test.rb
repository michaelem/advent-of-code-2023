...
class Day4::ScratchcardTest < Minitest::Test
  def test_parse_card_a
    card =
      Day4::Scratchcard.new("Card 1: 41 48 83 86 17 | 83 86  6 31 17  9 48 53")
    assert_equal "Card 1", card.name
    assert_equal 1, card.id
    assert_equal %w[41 48 83 86 17], card.numbers
    assert_equal %w[83 86 6 31 17 9 48 53], card.winning_numbers
  ...
  def test_parse_card_b
    ...
    assert_equal %w[3 87 49 74 88 50 90 2 10 11], card.numbers
    assert_equal %w[
                   68
                   34
                   89
